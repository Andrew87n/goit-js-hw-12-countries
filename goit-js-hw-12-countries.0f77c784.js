...
refs.input.addEventListener('input', (0, _lodashDebounceDefault.default)(onSearch, 300));
function onSearch(e) {
    ...
    fetchCountries(value).then((data)=>{
        if (data.length > 10) {
            clearMarkup();
            (0, _core.notice)({
                text: 'Too many matches. Try again.'
            });
            return;
        }
        if (data.length >= 2 && data.length <= 10) renderList(data);
        if (data.length === 1) renderInfo(data[0]);
    }).catch(()=>{
        clearMarkup();
        (0, _core.error)({
            text: 'Oops, there is no country with that name'
        });
    });
}
...
},{"lodash.debounce":"irvaP","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/mobile/dist/PNotifyMobile.css":"iv3sV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"irvaP":[function(require,module,exports,__globalThis) {
/**
...
},{}],"c4y47":[function() {},{}],"iv3sV":[function() {},{}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}]},["7wZbQ","2R06K"], "2R06K", "parcelRequirec490", {})
